...
% microCT data file
dataType = 'nii'; %tif or amira or nii
imgfolder = 'D:\code\InSegtCone\data\'; %if not defined, then popup window will come out to choose manually
Lblfolder = 'D:\code\InSegtCone\data\'; %if not defined, then popup window will come out to choose manually
datafilename = '60185_AM_F.nii.gz';
% label file
labelfilename = '60185_AM_F_manLabel.nii.gz';
